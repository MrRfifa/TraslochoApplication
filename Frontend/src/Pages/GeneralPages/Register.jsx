  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 gap-0 h-screen w-full">
      <animated.div style={fadeIn}>
        <div className="flex absolute items-center justify-center mt-3 ml-3 mb-3">
          <LabelDestinationLinkButton
            label={<FaHome size={24} />}
            destination="/"
          />
        </div>
        ...
        <div className="md:hidden w-full h-full flex  items-center justify-center bg-white text-black">
          {/* Small/ Medium screens */}
          <div className="text-black mx-auto">
            <GeneralCardSMScreen isOwner={false} />
          </div>
        </div>
      </animated.div>
      ...
      <animated.div style={fadeIn}>
        ...
        <div className="flex md:hidden w-full h-full  items-center justify-center bg-black text-white">
          {/* Small/ Medium screens */}
          <div className="text-white">
            <GeneralCardSMScreen isOwner={true} />
          </div>
        </div>
      </animated.div>
    </div>
